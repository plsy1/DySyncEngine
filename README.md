...
**DySyncEngine** 是一款专为高效同步、管理与沉浸式播放网络视频设计的现代化全栈引擎。它支持 **抖音 (Douyin)**、**TikTok** 的全量/增量抓取，提供 **快手 (Kuaishou)** 视频订阅同步，并支持快手与 **小红书 (XiaoHongShu)** 单作品视频/图文解析下载；同时集成了一个媲美原生的 **PWA 沉浸式视频播放器**，并支持将内容自动/手动推送至 **Telegram**。
...
### 1. 📥 智能抓取与下载
- **多平台支持**：支持抖音、TikTok、快手和小红书单个视频/图文作品解析下载。
...
> [!TIP]
> 快手的风控过于恶心了点，web端正常浏览都可能碰到不返回数据的情况，甚至还有限速。
---
